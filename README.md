...
Syntax keys, formatting, and project navigation: [Neovim editing](docs/neovim-editing.md).
Clipboard/opening behavior and platform limitations: [WSL interoperability](docs/wsl-interop.md).
